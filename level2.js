...
const animateTitle = document.querySelector('.level2-title');
...
function highScore(score) {
    if(!localStorage.getItem('#highscores2')) {
        localStorage.setItem('#highscores2', score);
        const highestScore = parseInt(localStorage.getItem('#highscores2'));
        document.querySelector('#bestscore2').innerHTML = `New Highest Record: ${highestScore}`;
    } else if (parseInt(score) > parseInt(localStorage.getItem('#highscores2'))) {
        localStorage.setItem('#highscores2', score);
        const highestScore = parseInt(localStorage.getItem('#highscores2'));
        document.querySelector('#bestscore2').innerHTML = `New Highest Record: ${highestScore}`;
    } else {
        const highestScore = parseInt(localStorage.getItem('#highscores2'));
        document.querySelector('#bestscore2').innerHTML = `Highest Record: ${highestScore}`;
    };
};
const highestScore = parseInt(localStorage.getItem('#highscores2'));
document.querySelector('#bestscore2').innerHTML = `Highest Record: ${highestScore}`;
